    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="maps.php">Find Nearest Station</a>
                </li>
                <li><hr class="dropdown-divider"></li>
                <li class="nav-item active">
                    <a class="nav-link" href="#">Purchase History <span class="sr-only">(current)</span></a>
                </li>
                <li><hr class="dropdown-divider"></li>
                <li class="nav-item">
...
<!--                
  ...
  <tbody>
    <?php for($i=0; $i <= 10; $i++ ): ?>
    <tr>
      <td scope="row">Fuel - Silk highway<br>2<?= $i ?> NOV</td>
    </tr>
    <?php endfor; ?>
    <!-- <tr>
      <th scope="row">2</th>
